...
TRANSACTION_EXECUTOR_IN_FILE = "packer/manifests/transaction-executor.json"
...
def main():
    ...
    tx_executor_amis = parse_manifest_file(TRANSACTION_EXECUTOR_IN_FILE)
    vault_amis = parse_manifest_file(VAULT_IN_FILE)

    output = {'tx_executor_amis': tx_executor_amis, 'vault_amis': vault_amis}
